...
export const MOCK_LOCATIONS: Location[] = [
  {
    id: '1', name: 'FitX München Zentrum', logo: { color: '#ef4444', imageUrl: null }, openingHours: defaultOpeningHours(), calendarExceptions: [], bundesland: 'BY', street: 'Karlsplatz 12', zip: '80335', city: 'München',
  ...
  {
    id: '2', name: 'McFIT Berlin Mitte', logo: { color: '#f97316', imageUrl: null }, openingHours: defaultOpeningHours(), calendarExceptions: [], bundesland: 'BE', street: 'Alexanderplatz 5', zip: '10178', city: 'Berlin',
  ...
  {
    id: '3', name: 'Gold\'s Gym Hamburg', logo: { color: '#eab308', imageUrl: null }, openingHours: defaultOpeningHours(), calendarExceptions: [], bundesland: 'HH', street: 'Reeperbahn 42', zip: '20359', city: 'Hamburg',
  ...
  {
    id: '4', name: 'Clever Fit Köln', logo: { color: '#22c55e', imageUrl: null }, openingHours: defaultOpeningHours(), calendarExceptions: [], bundesland: 'NW', street: 'Hohenzollernring 88', zip: '50672', city: 'Köln',
  ...
  {
    id: '5', name: 'John Reed Frankfurt', logo: { color: '#6366f1', imageUrl: null }, openingHours: defaultOpeningHours(), calendarExceptions: [], bundesland: 'HE', street: 'Zeil 15', zip: '60313', city: 'Frankfurt am Main',
  ...
  {
    id: '6', name: 'Urban Sports Club Stuttgart', logo: { color: '#14b8a6', imageUrl: null }, openingHours: defaultOpeningHours(), calendarExceptions: [], bundesland: 'BW', street: 'Königstraße 30', zip: '70173', city: 'Stuttgart',
  ...
  {
    id: '7', name: 'CrossFit Box Düsseldorf', logo: { color: '#8b5cf6', imageUrl: null }, openingHours: defaultOpeningHours(), calendarExceptions: [], bundesland: 'NW', street: 'Friedrichstraße 7', zip: '40217', city: 'Düsseldorf',
  ...
  {
    id: '8', name: 'Fitness First Nürnberg', logo: { color: '#3b82f6', imageUrl: null }, openingHours: defaultOpeningHours(), calendarExceptions: [], bundesland: 'BY', street: 'Breite Gasse 22', zip: '90402', city: 'Nürnberg',
  ...
  {
    id: '9', name: 'FitStar Leipzig', logo: { color: '#ec4899', imageUrl: null }, openingHours: defaultOpeningHours(), calendarExceptions: [], bundesland: 'SN', street: 'Augustusplatz 3', zip: '04109', city: 'Leipzig',
  ...
  {
    id: '10', name: 'Bodystreet Dresden', logo: { color: '#06b6d4', imageUrl: null }, openingHours: defaultOpeningHours(), calendarExceptions: [], bundesland: 'SN', street: 'Prager Straße 10', zip: '01069', city: 'Dresden',
